...
import { PostEntretienCollaborateur } from "@/components/entretiens/PostEntretienCollaborateur";

export default function PostCollaborateurPage({
  params,
}: {
  params: { id: string };
}) {
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl">
      ...
      <h1 className="text-2xl font-semibold text-applipro-dark mt-1 mb-2">
        Post-entretien — Collaborateur
      </h1>
      <p className="text-[14px] text-gris-60 mb-6">
        Synthèse de l&apos;entretien et feedback du collaborateur.
      </p>
      <PostEntretienCollaborateur entretienId={id} initialWizard={wizard} />
    </div>
  );
}
